...
import com.dev43.ecommerce.kafka.order.Product;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(
        ...
        //
        messageHelper.setFrom("dev43coding@gmail.com");
        ...
        try{
            ...
            log.info("INFO - Email send successfully send to {} with template {}",destinationEmail,templateName);
